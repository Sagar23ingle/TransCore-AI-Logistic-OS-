                ...
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="min-w-0 flex-1 overflow-hidden">
                    <div className="flex items-center gap-2 min-w-0">
                      <div className="truncate text-[15px] font-semibold tracking-tight min-w-0 flex-1">{v.registration_number}</div>
                      <Badge variant={v.status === "active" ? "default" : v.status === "maintenance" ? "outline" : "destructive"} className="h-5 px-1.5 text-[10px] shrink-0">
                        {v.status}
                      </Badge>
                    </div>
