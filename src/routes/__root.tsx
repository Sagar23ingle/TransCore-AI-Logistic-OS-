...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TransCore AI — Fleet & Logistics Platform" },
      { name: "description", content: "AI-powered fleet management: vehicles, drivers, trips, documents, live GPS tracking, expense analytics and smart alerts for truck owners and brokers." },
